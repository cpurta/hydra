...
export class ProcessorSchema1601637366182 implements MigrationInterface {
  name = 'ProcessorSchema1601637366182'
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    await queryRunner.query(
      `CREATE TABLE "processed_events_log" (
        ...
        CONSTRAINT "PK_2d074516252c7a3090ddc44b9a5" PRIMARY KEY ("id"))`
    )
    await queryRunner.query(
